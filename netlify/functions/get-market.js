...
const INFO = {
  ...
  "EU_HICP": "Eurozone inflation — how much prices for everyday goods and services have risen over the past year across the countries that use the euro. It's the number the European Central Bank tries to keep near 2%, and it ripples through the economy: it drives interest-rate decisions, sets the tone for how fast your own costs and prices move, and — because pay is meant to keep up with the cost of living — it heavily influences the annual salary increases companies budget for. Official figure, updated monthly.",
